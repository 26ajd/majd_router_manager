...
**Majd Router Manager** هو مشروع Flutter  يوضح كيفية إدارة **التنقل بين الشاشات** باستخدام **Route Manager خاص**، مع دعم كل أنواع التنقل وتمريرة البيانات بين الشاشات.
