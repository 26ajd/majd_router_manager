      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                MajdRouterManager.go(const SettingsScreen());
              },
            ...
            ElevatedButton(
              onPressed: () {
                MajdRouterManager.goNamed(AppRoutes.settings);
              },
            ...
            Container(
              ...
              child: const Text(
                "MajdRouterManager.goReplace(SettingsScreen())",
            ...
            ElevatedButton(
              onPressed: () {
                MajdRouterManager.goReplac(const SettingsScreen());
              },
            ...
            Container(
              ...
              padding: const EdgeInsets.all(8),
              child: const Text(
                "MajdRouterManager.goReplaceNamed(AppRoutes.settings)",
                style: TextStyle(fontFamily: 'monospace'),
              ),
            ),
            const SizedBox(height: 8),
            ...
            Container(
              ...
              padding: const EdgeInsets.all(8),
              child: const Text(
                "MajdRouterManager.goRemoveUntil(SettingsScreen())",
                style: TextStyle(fontFamily: 'monospace'),
              ),
            ),
            const SizedBox(height: 8),
            ElevatedButton(
              onPressed: () {
                MajdRouterManager.goAndRemoveUntil(const SettingsScreen());
              },
            ...
            Container(
              ...
              padding: const EdgeInsets.all(8),
              child: const Text(
                "MajdRouterManager.goNamedAndRemoveUntil(AppRoutes.home)",
                style: TextStyle(fontFamily: 'monospace'),
              ),
            ),
            const SizedBox(height: 8),
            ...
            const SizedBox(height: 24),
            ElevatedButton(
              onPressed: () => MajdRouterManager.back(),
